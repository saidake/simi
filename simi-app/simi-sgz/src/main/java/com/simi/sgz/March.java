...
//    public static Map<Integer, Coordinate> PI_BTN_MAP=new HashMap<>(){{
//        put(1,PI_BT1);
//        put(2,PI_BT2);
//        put(3,PI_BT3);
//        put(4,PI_BT4);
//    }};
//    public static Map<Integer, Coordinate> PI_TAB_MAP=new HashMap<>(){{
//        put(1,PI_TAB1);
//        put(2,PI_TAB2);
//        put(3,PI_TAB3);
//    }};
//    public static Map<Integer, Coordinate> PI_ARMY_MAP=new HashMap<>(){{
//        put(11,PI_ARMY1_FROM1);
//    }};
//    public static Map<Integer, Coordinate> PI_MARK_MAP=new HashMap<>(){{
//        put(1,PI_MARK1);
//        put(2,PI_MARK2);
//        put(3,PI_MARK3);
//    }};
//    public static Map<Integer, Coordinate> PU_BTN_MAP=new HashMap<>(){{
//        put(1,PU_BT1);
//        put(2,PU_BT2);
//    }};
//    public static Map<Integer, Coordinate> PU_TAB_MAP=new HashMap<>(){{
//        put(1,PU_TAB1);
//        put(2,PU_TAB2);
//        put(3,PU_TAB3);
//    }};
//    public static Map<Integer, Coordinate> PU_ARMY_MAP=new HashMap<>(){{
//        put(11,PU_ARMY1_FROM1);
//        put(22,PU_ARMY2_FROM2);
//    }};
//    public static Map<Integer, Coordinate> PU_MARK_MAP=new HashMap<>(){{
//        put(1,PU_MARK1);
//        put(2,PU_MARK2);
//        put(3,PU_MARK3);
//    }};
//    public static Map<Integer, Coordinate> DU_BTN_MAP=new HashMap<>(){{
//        put(1,DU_BT1);
//        put(2,DU_BT2);
//    }};
//    public static Map<Integer, Coordinate> DU_TAB_MAP=new HashMap<>(){{
//        put(1,DU_TAB1);
//        put(2,DU_TAB2);
//        put(3,DU_TAB3);
//    }};
//    public static Map<Integer, Coordinate> DU_ARMY_MAP=new HashMap<>(){{
//        put(11,DU_ARMY1_FROM1);
//    }};
//    public static Map<Integer, Coordinate> DU_MARK_MAP=new HashMap<>(){{
//        put(1,DU_MARK1);
//        put(2,DU_MARK2);
//        put(3,DU_MARK3);
//
...
//    }
//
//    public static void retreat(RobotAction robot) {
...
//
//
//    public static void resetScreenToMark(RobotAction robot, int mark) {
...
//
//
//    public static void pineappleStopAndMarchToMark(RobotAction robot, int btn, int tab, int army, int mark) {
//        // select location
...
//    }
//    public static void pumpkinStopAndMarchToMark(RobotAction robot, int btn, int tab, int army, int mark) {
//        // select location
...
//
//    }
//    public static void durianStopAndMarchToMark(RobotAction robot, int btn, int tab, int army, int mark) {
//        // select location
...
//
//    }
//    public static void pineappleMarch(RobotAction robot, int btn, int tab, int army) {
//
//        // select location
//        robot.leftMouseClick(PI_RED_POINT);
//        // march button
...
//    }
//    public static void pineappleMarch(RobotAction robot, int btn, int tab, int army, int mark){
...
//        robot.leftMouseClick(PI_CONFIRM, WT2);
//    }
//    public static void pumpkinMarch(RobotAction robot, int btn, int tab, int army) {
//        // select location
//        robot.leftMouseClick(PU_RED_POINT);
//        // march button
...
//    }
//    public static void pumpkinMarch(RobotAction robot, int btn, int tab, int army, int mark) {
...
//        robot.leftMouseClick(PU_CONFIRM, WT2);
//    }
//    public static void durianMarch(RobotAction robot, int btn, int tab, int army) {
//        // select location
//        robot.leftMouseClick(DU_RED_POINT);
//        // march button
...
//    }
//    public static void durianMarch(RobotAction robot, int btn, int tab, int army, int mark) {
