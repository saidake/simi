...
@UtilityClass
@Slf4j
public class SimiXmlUtils {

    /**
     * A temporary prefix for xmln xmls file to locate namespace.
     */
    private static final String TEMP_XMLN_PREFIX ="simi";
    ...
    public static Node selectSingleNodeListWithNSXpath(@Nullable HashMap<String, String> pomNameSpaceMap, Node readPomDocument, String replaceNodeXpath) {
    ...
    public static List<Node> selectNodeListWithNSXpath(@Nullable HashMap<String, String> pomNameSpaceMap, Node readPomDocument, String replaceNodeXpath) {
    ...
    public static Optional<HashMap<String, String>> createNamespaceMap(Document document) {
