...
public class MainTest {
    ...
    public static void main(String[] args)  {
        ...
        Pattern functionStartPattern = Pattern.compile(String.format("^[^\"]+%s\\s*\\([^\"]*?\\)\\s*\\{\\s*", "main"));
        Matcher matcher = functionStartPattern.matcher("    public static void main(String[] args)  {");
