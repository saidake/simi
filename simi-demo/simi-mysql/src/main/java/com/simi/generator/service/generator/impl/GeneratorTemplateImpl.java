//package com.simi.generator.service.generator.impl;
//
//import com.simi.common.core.util.data.*;
//import com.simi.generator.AAAconfig.properties.GeneratorProperties;
...
//import com.simi.generator.mybatis.mapper.DatabaseMapper;
//import com.simi.generator.service.generator.GeneratorTemplate;
//import com.simi.common.core.util.file.FileUtil;
...
//            //1. 写模板文件，获取 将要生成的文件路径【service，serviceImpl，mapper，mapperResources，com.simi.citi.controller】
...
//            // service  serviceImpl   mapper  mapperResources  com.simi.citi.controller
//            HashMap<Integer, String> checkMap = MapUtil.of(0, "service", 1, "serviceImpl", 2, "mapper", 3, "mapperResources", 4, "com.simi.citi.controller");
...
//    }
//
//    //写入模板文件   0 service 1 serviceImpl  2  com.simi.citi.controller
//    @Override
...
//                }
//                // 3). 在末尾，包含特殊服务时，com.simi.citi.controller 写特殊服务
...
//            HashMap<Integer, String> checkMap = MapUtil.of(0, "service", 1, "serviceImpl", 2, "com.simi.citi.controller");  // 各个索引都是什么东西
...
//                    readServiceLine = readServiceLine.replace(generatorProperties.getTemplate().getTableComment(), loginComment);  //表注释替换【com.simi.citi.controller】
...
//                    if (isSpecial) {
//                        String loginComment = currentServiceMethodConfig.getName().get(1);
//                        readServiceLine = readServiceLine.replace(generatorProperties.getTemplate().getTableComment(), currentTableComment + loginComment);  //表注释替换【com.simi.citi.controller】
//                        if (readServiceLine.contains("接口"))
//                            readServiceLine = readServiceLine.replace("表", "");  //表注释替换【com.simi.citi.controller】
//                    } else {
//                        readServiceLine = readServiceLine.replace(generatorProperties.getTemplate().getTableComment(), currentTableComment);  //表注释替换【com.simi.citi.controller】
//                    }
//                    bufferedWriter.write(readServiceLine);  //大写表名替换
//                    bufferedWriter.write(separator);
//                }
...
//    ) {
//
//        if ("com.simi.citi.controller".equals(writeType)
...
//                bufferedReader.reset();
//                bufferedWriter.close();
//                log.info("pass com.simi.citi.controller table: {}", tableEntity.getTableName());
//
//            } catch (IOException e) {
//                e.printStackTrace();
//            }
...
//                    enterTime -= count2;
//                }
//                List<String> checkList = Arrays.asList("com.simi.citi.controller", "service", "serviceImpl");
//                //在开头import
...
//                    bufferedWriter.write(readServiceLineBuilderStartPackage.toString());
//                }
//                //在末尾，包含特殊服务时，com.simi.citi.controller 写特殊服务
...
//            readServiceLineBuilderEnd.append("\t}");
//            readServiceLineBuilderEnd.append(separator);
//        // 4.3 为 com.simi.citi.controller 添加参数定义，并添加调用service和return代码
//        } else if ("com.simi.citi.controller".equals(writeType)) {
//            //写注解
//            readServiceLineBuilderEnd.append(separator);
//            //根据get post 确定参数
//            if ("post".equals(method) && itemRequest != null && itemRequest.size() > 0) {
